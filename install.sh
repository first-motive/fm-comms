...
#
#   curl -fsSL https://raw.githubusercontent.com/first-motive/fm-comms/v0.2.0-zenoh.4/install.sh | bash -s -- --role router
#
# Inspect before running (always available):
#
#   curl -fsSL https://raw.githubusercontent.com/first-motive/fm-comms/v0.2.0-zenoh.4/install.sh -o install.sh
